...
import type { Lang, TranslateOptions } from '../core'
 ...
 * 翻译 markdown 内容配置
 */
interface TranslateMarkdownOptions extends TranslateOptions {
 ...
 * 翻译 markdown 文件配置
 */
export interface TranslateMarkdownFileOptions extends TranslateOptions {
  /**
   * 文件路径
   */
  path: string
